...
public abstract class CollideShapeBodyResultCallback {
    ...
    private static final Map<Long, WeakReference<CollideShapeBodyResultCallback>> CACHE;
    ...
    public static @Nullable CollideShapeBodyResultCallback get(MemorySegment segment) {
