...
public abstract class CastRayCollectorCallback {
    ...
    private static final Map<Long, WeakReference<CastRayCollectorCallback>> CACHE;
    ...
    public float invoke(
        ...
        throw new UnsupportedOperationException(
            "Override either the typed or raw callback method in CastRayCollectorCallback."
        );
    };
    ...
    public static @Nullable CastRayCollectorCallback get(MemorySegment segment) {
