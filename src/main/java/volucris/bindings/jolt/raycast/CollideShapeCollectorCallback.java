...
public abstract class CollideShapeCollectorCallback {
    ...
    private static final Map<Long, WeakReference<CollideShapeCollectorCallback>> CACHE;
    ...
    public static @Nullable CollideShapeCollectorCallback get(MemorySegment segment) {
