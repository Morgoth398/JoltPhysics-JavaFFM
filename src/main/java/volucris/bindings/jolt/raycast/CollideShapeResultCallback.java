...
public abstract class CollideShapeResultCallback {
    ...
    private static final Map<Long, WeakReference<CollideShapeResultCallback>> CACHE;
    ...
    public static @Nullable CollideShapeResultCallback get(MemorySegment segment) {
