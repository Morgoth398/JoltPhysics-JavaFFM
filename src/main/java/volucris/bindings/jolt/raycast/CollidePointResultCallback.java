...
public abstract class CollidePointResultCallback {
    ...
    private static final Map<Long, WeakReference<CollidePointResultCallback>> CACHE;
    ...
    public static @Nullable CollidePointResultCallback get(MemorySegment segment) {
